...
class ResultsAndProductsPageMultifocalMonovision extends StatefulWidget {
  ResultsAndProductsPageMultifocalMonovision({Key? key}) : super(key: key);

  @override
  State<ResultsAndProductsPageMultifocalMonovision> createState() =>
      _ResultsAndProductsPageMultifocalMonovision();
}

class _ResultsAndProductsPageMultifocalMonovision
    extends State<ResultsAndProductsPageMultifocalMonovision> {
  @override
